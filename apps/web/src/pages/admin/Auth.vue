...
const PROVIDER_META: Record<ProviderConfig['provider'], {
  ...
  github: {
    ...
    docsUrl: 'https://perch.lxghtblvee.dev/docs/auth/sso/github',
    bg: 'bg-[#161b22]',
    iconSize: 'size-5',
  },
  google: {
    ...
    docsUrl: 'https://perch.lxghtblvee.dev/docs/auth/sso/google',
    bg: 'bg-white',
    iconSize: 'size-5',
  },
  microsoft: {
    ...
    docsUrl: 'https://perch.lxghtblvee.dev/docs/auth/sso/microsoft',
    bg: 'bg-[#f3f3f3]',
    iconSize: 'size-5',
  },
  gitlab: {
    ...
    docsUrl: 'https://perch.lxghtblvee.dev/docs/auth/sso/gitlab',
    bg: 'bg-[#1a1a2e]',
    iconSize: 'size-5',
  },
  discord: {
    ...
    docsUrl: 'https://perch.lxghtblvee.dev/docs/auth/sso/discord',
    bg: 'bg-[#5865f2]',
    iconSize: 'size-5',
  },
  okta: {
    ...
    icon: '/icons/okta.svg',
    docsUrl: 'https://perch.lxghtblvee.dev/docs/auth/sso/okta',
    bg: 'bg-[#00297a]',
    iconSize: 'size-5',
  },
  custom: {
    ...
    icon: '',
    docsUrl: 'https://perch.lxghtblvee.dev/docs/auth/sso/custom',
    bg: 'bg-primary/20',
    iconSize: 'size-5',
  },
}
