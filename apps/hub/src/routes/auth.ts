...
export const authRoutes = new Elysia({ prefix: '/api/auth' })
    ...
    .get('/recover', async ({ query, redirect }) => {
        const { token } = query
    ...
    // Initiate OAuth flow
    .get('/:provider', async ({ params, request, redirect }) => {
    ...
    // OAuth callback
    .get('/:provider/callback', async ({ params, query, request, redirect }) => {
        const { provider } = params
